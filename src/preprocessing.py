...
def load_gene_references():
    """Load gene references from TSV file generated by Go code."""
    filepath = os.path.join('data', 'processed_data', 'gene_references.tsv')
    return pd.read_csv(filepath, sep='\t')

def load_protein_data():
    """Load protein information from TSV file."""
    filepath = os.path.join('data', 'processed_data', 'protein_info.tsv')
    return pd.read_csv(filepath, sep='\t')
